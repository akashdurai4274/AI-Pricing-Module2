...
export default function EstimateSection() {
  ...
  const [selectedChatbotPlan, setSelectedChatbotPlan] = useState("intelligence")
  // Chatbot addons
  ...
  const calculateChatbotPrice = () => {
    ...
    if (selectedChatbotPlan === "intelligence" && chatCount > 200) {
      usage = "high"
    } else if (selectedChatbotPlan === "super-intelligence" && chatCount > 1000) {
      usage = "high"
    }
    ...
    return {
      ...
      usage,
      tringAIPercentage: chatbotAddons.whatsapp ? Math.round((10 / 10.5) * 100) : 100,
      whatsappPercentage: chatbotAddons.whatsapp ? Math.round((0.5 / 10.5) * 100) : 0,
    }
  }
  ...
  return (
    <section className="py-8 md:py-12 lg:py-16 px-4 sm:px-8 md:px-12 lg:px-20 xl:px-28" ref={calculatorRef}>
      <div className="relative mb-8">
        ...
        <h2 className="text-2xl md:text-3xl font-bold mb-2">
          Estimate your <span className="bg-blue-100 text-blue-600 px-2 py-1 rounded">monthly cost</span>
        </h2>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center border-2  rounded-md bg-gray-200">
                  <input
                    type="number"
                    value={chatCount}
                    onChange={(e) => setChatCount(Number.parseInt(e.target.value) || 0)}
                    className="border-y bg-gray-200  p-2 text-center w-full"
                  />
                  <div className="flex space-x-2">
                    <button onClick={() => decrementChat()} className=" p-2 rounded-full bg-white text-blue-500">
                      <Minus size={16} />
                    </button>
                    <button onClick={() => incrementChat()} className="p-2 rounded-full bg-blue-500 text-white">
                      <Plus size={16} />
                    </button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor="no-branding-chat" className="ml-2 text-sm">
              ...
              <div className="border-t pt-4">
                ...
                <div className="text-xl font-bold">
                  {formatPrice(convertPrice(chatbotAddons.whatsapp ? 10.5 : 10))}
                  /chat
                </div>

                <div className="mt-4 h-10 bg-gray-200 rounded-md overflow-hidden">
                  <div className="flex h-full">
                    <div className="bg-blue-600 h-full" style={{ width: `${chatbotPricing.tringAIPercentage}%` }}></div>
                    {chatbotAddons.whatsapp && (
                      <div
          ...
          {voicebotActive ? (
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center border-2  rounded-md bg-gray-200">
                  <input
                    type="number"
                    value={minuteCount}
                    onChange={(e) => setMinuteCount(Number.parseInt(e.target.value) || 0)}
                    className="border-y bg-gray-200  p-2 text-center w-full"
                  />
                  <div className="flex space-x-2">
                    <button onClick={() => decrementMinutes()} className=" p-2 rounded-full bg-white text-blue-500">
                      <Minus size={16} />
                    </button>
                    <button onClick={() => incrementMinutes()} className="p-2 rounded-full bg-blue-500 text-white">
                      <Plus size={16} />
                    </button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor="multiple-languages" className="ml-2 text-sm">
                        Multiple languages
                      </label>
                    </div>
                    <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor="no-branding-voice" className="ml-2 text-sm">
                        No Tring AI branding
                      </label>
                    </div>
                  </div>
              ...
              <div className="border-t pt-4">
                ...
                <div className="text-xl font-bold">₹{minuteCount <= 5000 ? "6" : "8"}/minute</div>
              ...
              <div className="flex flex-col gap-6">
                <div className="md:w-2/2">
                  <h3 className="text-xl font-bold text-gray-800 mb-2">
                    AI Voice for <span className="text-blue-600">Instant Engagement</span>
                  </h3>
                  <p className="text-gray-600 mb-4">
                    Enhance your chatbot with a voicebot to handle calls, answer queries, and engage customers through
          ...
          {voicebotActive && !chatbotActive && (
            <div className="md:col-span-2 bg-white p-6 rounded-lg shadow-sm">
              <div className="flex flex-col md:flex-row gap-6">
                <div className="md:w-1/2">
                  <h3 className="text-xl font-bold text-gray-800 mb-2">
                    Smart Chatbot for <span className="text-blue-600">Instant Engagement</span>
                  </h3>
                  <p className="text-gray-600 mb-4">
                    Let your voicebot handle incoming calls, then seamlessly transfer queries or follow-ups to the
                    Chatbot for instant responses and continued assistance 24/7
                  </p>
        ...
        <div className="bg-blue-600 text-white p-6 rounded-lg shadow-sm">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-2">
              <span className={`text-xs ${billingPeriod === "monthly" ? "text-white" : "text-white/60"}`}>Monthly</span>
              <Switch
                checked={billingPeriod === "yearly"}
                onCheckedChange={(checked) => setBillingPeriod(checked ? "yearly" : "monthly")}
                className="data-[state=checked]:bg-white data-[state=unchecked]:bg-white/40"
              />
              <span className={`text-xs ${billingPeriod === "yearly" ? "text-white" : "text-white/60"}`}>Yearly</span>
            </div>
          </div>
          ...
          {voicebotActive && !chatbotActive && (
            <>
              ...
              <Button className="w-full bg-white text-blue-600 hover:bg-blue-50 mb-4">Add Voicebot</Button>
              ...
              <div className="border-t border-white/20 pt-4 mt-4">
                ...
                <p className="text-sm opacity-80 mb-4">does not include applicable taxes</p>
                <button className="text-sm underline">Share this price</button>
              </div>

              <Button className="w-full bg-[#FDB137] hover:bg-[#f0a52c] text-white mt-6">Start free trial</Button>
            </>
          )}
            ...
            <>
              ...
              {chatbotPricing.usage === "high" && (
                <div className="bg-orange-500/20 text-white p-3 rounded-md mb-6">
                  <p className="text-sm">Your usage is high. Consider contacting sales for a custom enterprise plan.</p>
                </div>
              )}

              <Button className="w-full bg-white text-blue-600 hover:bg-blue-50 mb-4">Add Chatbot</Button>
              ...
              >
                ...
                <span className="text-yellow-300 font-medium">Add Voicebot</span>
              </div>
            ...
            <>
              ...
              <div className="space-y-4 flex flex-col justify-center items-center mb-6 p-2">
                <div className="bg-blue-700 w-full p-4  h-auto rounded-md flex flex-col justify-between items-start">
                  <span className="text-2xl text-clip font-bold text-orange-400">{chatbotPricing.plan}</span>
                  <span className="text-lg opacity-80">plus add-ons</span>
                  <span>
                    <span className="text-3xl font-bold">{formatPrice(convertPrice(chatbotPricing.totalPrice))}</span>
                    <span className="text-sm font-normal opacity-80">/ month</span>
                  </span>
                </div>
                <div className="bg-blue-700 w-full p-4  h-auto rounded-md flex flex-col justify-between items-start">
                  <span className="text-2xl text-clip font-bold text-orange-400">{voicebotPricing.plan} </span>
                  <span className="text-lg opacity-80">plus add-ons</span>

                  <span>
                    <span className="text-3xl font-bold">{formatPrice(convertPrice(voicebotPricing.totalPrice))}</span>
                    <span className="text-sm font-normal opacity-80">/ month</span>
                  </span>
                </div>
              </div>
              ...
              <div className="border-t border-white/20 pt-4 mt-4">
                <div className="text-3xl font-bold mb-1">
                  {formatPrice(convertPrice(totalPrice))} <span className="text-sm font-normal opacity-80">/month</span>
                </div>
                <p className="text-sm opacity-80 mb-4">does not include applicable taxes</p>
                <button className="text-sm underline">Share this price</button>
              </div>
