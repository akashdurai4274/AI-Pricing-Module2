  ...
  return (
    <div className="my-12 px-52">
      <div className="max-w-xl mx-auto mb-8">
        <div className="flex rounded-lg overflow-hidden shadow-sm">
          <button
            ...
            className={`w-1/2 py-5 text-xl font-medium transition-colors rounded-lg ${
              activeTab === "chatbot"
      ...
      <div>
        {activeTab === "chatbot" && (
          <ChatbotPricing
            onCalculatePrice={(plan) => scrollToCalculator("chatbot", plan)}
          />
        )}
        {activeTab === "voicebot" && (
          <VoicebotPricing
            onCalculatePrice={(plan) => scrollToCalculator("voicebot", plan)}
          />
        )}
      </div>
    </div>
